...
public interface NewBestBlockListener {
     ...
     * or {@link TransactionReceivedInBlockListener#notifyTransactionIsInBlock(org.bitcoincashj.core.Sha256Hash, StoredBlock, AbstractBlockChain.NewBlockType, int)}.
