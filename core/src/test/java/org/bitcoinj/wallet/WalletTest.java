...
public class WalletTest extends TestWithWallet {
    ...
    private Transaction cleanupCommon(Address destination) throws Exception {
        ...
        SendRequest req = SendRequest.to(PARAMS, destination.toBase58(), v2);
    ...
    public void cleanupFailsDueToSpend() throws Exception {
        ...
        SendRequest req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), v3);
    ...
    private void basicSpendingCommon(Wallet wallet, Address toAddress, Address destination, Wallet encryptedWallet) throws Exception {
        ...
        SendRequest req = SendRequest.to(PARAMS, destination.toBase58(), vHuge);
        try {
            wallet.completeTx(req);
            fail();
        ...
        // Prepare to send.
        Coin v2 = valueOf(0, 50);
        req = SendRequest.to(PARAMS, destination.toBase58(), v2);
    ...
    private Wallet spendUnconfirmedChange(Wallet wallet, Transaction t2, KeyParameter aesKey) throws Exception {
        ...
        SendRequest req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(0, 48));
        req.aesKey = aesKey;
        req.shuffleOutputs = false;
        wallet.completeTx(req);
    ...
    public void doubleSpendWeCreate() throws Exception {
        ...
        try {
            ...
            SendRequest a1Req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(1, 0));
            a1Req.tx.addInput(txARoot.getOutput(0));
            a1Req.shuffleOutputs = false;
            wallet.completeTx(a1Req);
            Transaction txA1 = a1Req.tx;
            SendRequest a2Req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(2, 0));
            a2Req.tx.addInput(txARoot.getOutput(0));
            a2Req.shuffleOutputs = false;
            wallet.completeTx(a2Req);
            Transaction txA2 = a2Req.tx;
            SendRequest a3Req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(3, 0));
            ...
            SendRequest b1Req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(11, 0));
            b1Req.tx.addInput(txBRoot.getOutput(0));
            b1Req.shuffleOutputs = false;
            wallet.completeTx(b1Req);
            Transaction txB1 = b1Req.tx;
            SendRequest b2Req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(22, 0));
            ...
            SendRequest c1Req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(0, 10));
            ...
            SendRequest c2Req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(0, 20));
            ...
            SendRequest d1Req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(0, 1));
            d1Req.tx.addInput(txC1.getOutput(1));
            d1Req.shuffleOutputs = false;
            wallet.completeTx(d1Req);
            Transaction txD1 = d1Req.tx;
            SendRequest d2Req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(0, 2));
    ...
    public void sortTxnsByDependency() throws Exception {
        ...
        try {
            ...
            SendRequest req2a = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(100, 0));
            req2a.tx.addInput(send2.getOutput(0));
            req2a.shuffleOutputs = false;
            wallet.completeTx(req2a);
            Transaction send2a = req2a.tx;

            SendRequest req2b = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(50, 0));
            req2b.tx.addInput(send2a.getOutput(1));
            req2b.shuffleOutputs = false;
            wallet.completeTx(req2b);
            Transaction send2b = req2b.tx;

            SendRequest req2c = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), valueOf(25, 0));
    ...
    public void importAndEncrypt() throws InsufficientMoneyException {
        ...
        SendRequest req = SendRequest.emptyWallet(PARAMS, OTHER_ADDRESS.toBase58());
    ...
    public void sendRequestP2PKHTest() {
        SendRequest req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), SATOSHI.multiply(12));
    ...
    public void feeSolverAndCoinSelectionTest_dustySendRequested() throws Exception {
        ...
        try {
            SendRequest request = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), SATOSHI);
            request.ensureMinRequiredFee = true;
            wallet.completeTx(request);
            fail();
    ...
    public void basicFeeSolverTests() throws Exception {
        ...
        SendRequest request1 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT.subtract(SATOSHI));
        ...
        SendRequest request3 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT.subtract(SATOSHI));
        ...
        // ...unless we need it
        SendRequest request4 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT.subtract(SATOSHI));
        ...
        SendRequest request5 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), Coin.COIN.subtract(CENT.subtract(SATOSHI)));
        ...
        SendRequest request7 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), Coin.COIN.subtract(CENT.subtract(SATOSHI.multiply(2)).multiply(2)));
        ...
        SendRequest request8 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), COIN.subtract(Transaction.REFERENCE_DEFAULT_MIN_TX_FEE));
        ...
        SendRequest request9 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), COIN.subtract(
        ...
        SendRequest request10 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), COIN.subtract(
        ...
        SendRequest request11 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), COIN.subtract(
    ...
    public void feeSolverAndCoinSelectionTests2() throws Exception {
        ...
        // Now test feePerKb
        SendRequest request15 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        for (int i = 0; i < 29; i++)
        ...
        SendRequest request16 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        ...
        SendRequest request17 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        for (int i = 0; i < 22; i++)
        ...
        SendRequest request18 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        for (int i = 0; i < 22; i++)
        ...
        SendRequest request19 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        ...
        SendRequest request20 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        ...
        SendRequest request21 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        ...
        SendRequest request25 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        ...
        SendRequest request26 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        for (int i = 0; i < 98; i++)
    ...
    public void basicCategoryStepTest() throws Exception {
        ...
        SendRequest request1 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), balance.subtract(SATOSHI));
        request1.ensureMinRequiredFee = true;
        wallet.completeTx(request1);
        ...
        SendRequest request2 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), balance.subtract(SATOSHI));
        ...
        SendRequest request3 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT.add(tenThousand).subtract(SATOSHI));
        request3.ensureMinRequiredFee = true;
        wallet.completeTx(request3);
        ...
        //
        SendRequest request4 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), balance.subtract(SATOSHI));
        ...
        SendRequest request5 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT.add(tenThousand).subtract(SATOSHI));
        request5.ensureMinRequiredFee = true;
        wallet.completeTx(request5);
        ...
        SendRequest request6 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT.add(tenThousand).subtract(SATOSHI));
    ...
    public void testCategory2WithChange() throws Exception {
        ...
        SendRequest request1 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT.add(SATOSHI));
        request1.ensureMinRequiredFee = true;
        wallet.completeTx(request1);
        assertEquals(Transaction.REFERENCE_DEFAULT_MIN_TX_FEE, request1.tx.getFee());
        assertEquals(request1.tx.getInputs().size(), i); // We should have spent all inputs
    ...
    public void transactionGetFeeTest() throws Exception {
        ...
        SendRequest request = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
    ...
    public void lowerThanDefaultFee() throws InsufficientMoneyException {
        ...
        receiveATransactionAmount(wallet, myAddress, Coin.COIN);
        SendRequest req = SendRequest.to(PARAMS, myAddress.toBase58(), Coin.CENT);
        req.feePerKb = fee;
        wallet.completeTx(req);
        assertEquals(Coin.valueOf(1135).divide(feeFactor), req.tx.getFee());
        wallet.commitTx(req.tx);
        SendRequest emptyReq = SendRequest.emptyWallet(PARAMS, myAddress.toBase58());
    ...
    public void testCompleteTxWithExistingInputs() throws Exception {
        ...
        SendRequest request1 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        ...
        SendRequest request2 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        ...
        SendRequest request3 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
        ...
        SendRequest request4 = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), CENT);
    ...
    public void testEmptyRandomWallet() throws Exception {
        ...
        SendRequest request = SendRequest.emptyWallet(PARAMS, OTHER_ADDRESS.toBase58());
        wallet.completeTx(request);
    ...
    public void testEmptyWallet() throws Exception {
        ...
        request = SendRequest.emptyWallet(PARAMS, OTHER_ADDRESS.toBase58());
        wallet.completeTx(request);
        assertEquals(ZERO, request.tx.getFee());
        wallet.commitTx(request.tx);
        assertEquals(ZERO, wallet.getBalance());
    ...
    public void sendRequestExchangeRate() throws Exception {
        receiveATransaction(wallet, myAddress);
        SendRequest sendRequest = SendRequest.to(PARAMS, myAddress.toBase58(), Coin.COIN);
    ...
    public void totalReceivedSent() throws Exception {
        ...
        SendRequest req = SendRequest.to(PARAMS, OTHER_ADDRESS.toBase58(), Coin.COIN.multiply(3));
        wallet.completeTx(req);
