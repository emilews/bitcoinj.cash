...
public class PaymentChannelStateTest extends TestWithWallet {
    ...
    public void setupDoS() throws Exception {
        ...
        Transaction spendCoinTx = wallet.sendCoinsOffline(SendRequest.to(PARAMS, new ECKey().toAddress(PARAMS).toBase58(), COIN));
    ...
    public void feesTest() throws Exception {
        ...
        // Spend the client wallet's one coin
        final SendRequest request = SendRequest.to(PARAMS, new ECKey().toAddress(PARAMS).toBase58(), COIN);
